...
# Lazy cache for storing collatz lengths of seen numbers
collatz_cache = {}
...
def collatz_eval (i, j) :
    ...
    # Swap if numbers are in decreasing order
    if i > j :
        t = i
        i = j
        j = t
    ...
    # Use trick to reduce length of range
    if i < j/2 :
        i = j/2
    
    # Figure out whether range cache is required
    range1 = i/1000
    range2 = j/1000
    assert range1 <= range2
    
    # If numbers are close, don't use range cache
    if range2 - range1 <= 1 :
        v = 1
    ...
    # If numbers are far, break range into three:
    # i upto first applicable range cache value
    # Last range cache value applicable upto j
    # Values in range cache
    else :
        v = 1
...
# Meta cache for 1000 ranges of size 1000 each
